                    ...
                    <ul className="flex flex-col w-full">
                        ...
                        <li className="my-px">
                            <a href="#"
                                ...
                                <span className="ml-3" onClick={()=>navigateTo("/play")}>Play</span>
                            </a>
                        </li>
                        <li className="my-px">
                            <a href="#"
                                ...
                                <span className="ml-3" onClick={() => navigateTo("/hls")}>hls </span>
                            </a>
                        </li>
                        <li className="my-px">
                            <a href="#"
                                ...
                                <span className="ml-3" onClick={() => navigateTo("/listen")}>Listen</span>
                            </a>
                        </li>
                        {/* <li className="my-px">
                            <a href="#"
